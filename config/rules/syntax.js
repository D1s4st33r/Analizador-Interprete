...
const syntax = {
	...
	assig: [types.name, '-', '>', val,'[\+\*/-%]',`${types.name}|${types.num}|${types.decimal}`,chars.fin],
	...
	if: [words.condition, chars.leftPar, `${types.vof}`, chars.rightPar, chars.leftKey, 'code', chars.rightKey],
	...
	accion: [words.funcion, types.name, '-', '>', chars.leftPar, val, chars.rightPar, chars.leftKey, 'code', chars.rightKey],
